...
var cAjax = /** @class */ (function () {
    ...
    cAjax.prototype.setToken = function (token) {
    ...
    cAjax.prototype.postFiles = function (serverURL, data) {
        if (localStorage.hasOwnProperty(cEnvt._tokenName)) {
            data.set(cEnvt._tokenName, localStorage.getItem(cEnvt._tokenName));
        }
        jQuery.ajax({
            'url': serverURL,
            'data': data,
    ...
    cAjax.prototype.getAjaxConf = function (completefunction, myUrl, data) {
        if (localStorage.hasOwnProperty(cEnvt._tokenName)) {
            data[cEnvt._tokenName] = localStorage.getItem(cEnvt._tokenName);
        }
        var retour = {
            'async': false,
            'cache': false,
